  ...
  return (
    <section className="shop-page">
      <div className="content shop-content">
        <PageIntroHeader
          intro_title="Women"
          description="New Arrivals Women Collection 2022"
        />
      </div>
        ...
        <div className="container">
          <Row gutter={[10, 20]} className="product-content">
            <Col md={6} className="left-bar">
              ...
              <Title level={4} className="title category-title">
                Categories
              </Title>
              ...
              <Title level={4} className="title filter-title">
                Filters
              </Title>
              <div className="filter-price">
                ...
                <div className="price-range-selector">
                  ...
                  <div className="filter-info">
                    ...
                    <div className="price">
                      Range: $ <span className="lover-val">0</span> - ${" "}
                      <span className="upper-val">50</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="filter-color">
                ...
                <ul className="categories-lists">{/* Colors */}</ul>
              </div>
            </Col>
                ...
                <Col md={12} className="price-behavior">
                  ...
                  <div className="sort-between-amount">
                    ...
                    >
                      ...
                      <Option value="hundred-to-oneFifty">
                        $100.00 - $150.00
                      </Option>
                      <Option value="oneFifty-to-twoHundred">
                        $150.00 - $200.00
                      </Option>
                    </Select>
                  </div>
