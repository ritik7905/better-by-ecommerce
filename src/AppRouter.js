...
// ===================Routes..===============
import { About_Page, blog_Details, Cart_Page, Contact_Page, Home_Page, Page_Not_Found, Sale_Page, Shop_Page } from './common/routes'

// ===================Pages===============
import { About, Cart, Contact, Home, PageNotFound, Sale, Shop, SingleBlogDetails } from './pages'
